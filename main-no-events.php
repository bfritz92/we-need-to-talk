<?php
/**
 * Template Name: Main Page (No Events)
 */
...
<?php $the_query = new WP_Query( array( 'posts_per_page' => '3', 'cat' => '3,7', 'orderby' => 'rand' ) ); ?>
...
<?php while ($the_query -> have_posts()) : $the_query -> the_post(); ?>
		...
		<div class="cell small-12 medium-6 large-4 front-page-panels" >
			...
			<div class="">
				<a href="<?php the_permalink() ?>" ><h4 class="yellow-link"><?php the_title(); ?></h4></a>
...
?>
	...
	<section class="front-page-videos charcoal-bg pt-3 pb-2">
		...
		<div class=" grid-x grid-padding-x pt-2 align-middle contained">
			...
			<div class="cell small-8 small-offset-4 medium-offset-0 medium-6 large-4 front-page-video-link">
				<a class="" href="/stories/"><h5 class="pl-1 yellow-link">Watch More Videos About Youth Mental Health</h5></a>
			</div>
		</div>
	</section>
