...
function site_scripts() {
  global $wp_styles; // Call global $wp_styles variable to add conditional wrapper around ie stylesheet the WordPress way
	...
	// Register REST API scripts
    wp_enqueue_script( 'restapi-js', get_template_directory_uri() . '/assets/js/rest-api.js', array( 'jquery' ), filemtime(get_template_directory() . '/assets/scripts'), true );
...
add_action('wp_enqueue_scripts', 'site_scripts', 0);